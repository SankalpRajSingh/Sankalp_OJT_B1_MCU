...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, Motor_O_P_Pin|Motor_O_P1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : Motor_O_P_Pin Motor_O_P1_Pin */
  GPIO_InitStruct.Pin = Motor_O_P_Pin|Motor_O_P1_Pin;
